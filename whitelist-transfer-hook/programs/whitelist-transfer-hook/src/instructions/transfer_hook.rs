...
use crate::{constant::{EXTRA_ACCOUNT_METAS_SEED, WHITELISTED_USER_SEED}, error::ErrorCode, state::WhitelistedUser};
...
pub struct TransferHook<'info> {
    ...
    #[account(
        seeds = [WHITELISTED_USER_SEED, source_token.owner.key().as_ref()],
